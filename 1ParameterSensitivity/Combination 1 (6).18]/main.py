...
from tensorflow.keras.models import Model # FOR NASNETLarge and XCEPTION
from tensorflow.keras.layers import GlobalAveragePooling2D # FOR NASNETLarge and XCEPTION
