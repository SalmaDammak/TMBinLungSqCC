classdef Experiment < handle
    ...
    methods (Access = private)
        ...
        function [sCompletedExperimentPath, bErrored] = RunMain(obj)
            ...
            if isempty(oError) && obj.bCreateDistributedParpool % delete copied files on remote workers if needed
                try
...
%                         end
    ...
    methods (Access = private, Static = true)
        ...
        function [chRepoName, chBranchName, chCommitId, chGithubRepoRemoteUrl] = GetGitMetadata(chRepoPath)
            ...
            % get commit number
            chText = fileread(fullfile(chRepoPath, Experiment.chGitBranchesMetadataPath, chBranchName));
            chCommitId = chText(1:end-1);
