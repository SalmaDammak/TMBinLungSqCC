classdef NIfTILabelMapRegionsOfInterest < LabelMapRegionsOfInterest
    ...
    methods (Access = public)
        ...
        function obj = NIfTILabelMapRegionsOfInterest(chFilePath)
            ...
            oOnDiskImageVolumeGeometry = NIfTIImageVolume.GetImageVolumeGeometryFromFileMetaData(stFileMetadata);
