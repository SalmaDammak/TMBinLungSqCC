classdef MATLABMachineLearningHyperParameterOptimizer < HyperParameterOptimizer
    ...
    %
    % The MATLABMachineLearningOptimizeParameters class is designed specifically
    ...
    %              Diagrams\MATLABMachineLearningOptimizeParameters.png
    ...
    methods  (Access = public, Static = false)
        ...
        function obj = MATLABMachineLearningHyperParameterOptimizer(chOptimizationParameterFilename, oLabelledFeatureValues)
            %obj = MATLABMachineLearningOptimizeParameters(chOptimizationOptionsFileName,oLabelledFeatureValues)
            %
            % SYNTAX:
            %  obj = MATLABMachineLearningOptimizeParameters(chOptimizationOptionsFileName,oLabelledFeatureValues)
            %
            % DESCRIPTION:
            %  Constructor for MATLABMachineLearningOptimizeParameters
    ...
    methods (Access = {?MATLABClassifier}, Static = false)
        ...
        function [obj, oModel,oHyperParameterOptimizationResults] = OptimizeParameters(obj,oClassifier, NameValueArgs)
            ...
            if ( (strcmp(chClassifierFunctionName,'fitcknn')) || ...
                    (strcmp(chClassifierFunctionName,'fitcsvm')) || ...
                    (strcmp(chClassifierFunctionName,'fitctree')) ||...
                    (strcmp(chClassifierFunctionName,'fitcnb')) ||...
                    (strcmp(chClassifierFunctionName,'fitcdiscr')))
            ...
            elseif ( (strcmp(chClassifierFunctionName,'fitclinear')) || ...
                    (strcmp(chClassifierFunctionName,'fitckernel')) )
                ...
                stErr.message = char("OptimizeParameters does not recognize the classifier : " ...
                    + oClassifier.sName + newline ...
                    + "If this is a new classifier, the code for MATLABMachineLearningOptimizeParameters:OptimizeParameters" ...
                    + "must be updated.");
                stErr.identifier = 'MATLABMachineLearningOptimizeParameters:OptimizeParameters:UnrecognizedClassifier';
                error(stErr);
            end
